...
const Navbar = () => {
  ...
  return (
    <>
      <CartDrawer />
      <div className="bg-white sticky mb-2 lg:mb-0 md:mb-8 top-16 md:top-0 z-20">
        <div className="max-w-screen-2xl mx-auto px-3 sm:px-10">
          <div className="top-bar h-16 lg:h-auto flex items-center justify-between py-4 mx-auto">
              ...
              <div className="w-full flex flex-col justify-center flex-shrink-0 relative z-30">
                <div className="flex flex-col mx-auto w-full">
                  <form
                    ...
                    className="relative pl-1 pr-12 md:pr-14 bg-black overflow-hidden shadow-sm rounded-md w-full"
                  >
                    ...
                    <button
                      aria-label="Search"
                      type="submit"
                      className="outline-none text-xl text-white absolute top-0 right-0 end-0 w-12 md:w-14 h-full flex items-center justify-center transition duration-200 ease-in-out hover:text-heading focus:outline-none text-bold"
                    >
                      <IoSearchOutline />
                    </button>
                  </form>
            ...
            <div className="hidden md:hidden md:items-center lg:flex xl:flex items-center absolute inset-y-0 right-0 pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              {/* <button
              ...
              <button
                className="text-white text-2xl font-bold bg-black rounded-full w-10 h-10 flex items-center justify-center ml-5"
                aria-label="Login"
              >
                {userInfo?.image ? (
                  <Link
...
//     ProductServices.getShowingStoreAllProducts(),
//   ]);
