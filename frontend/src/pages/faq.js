          ...
          <div className="grid gap-4 lg:mb-8 items-center md:grid-cols-2 xl:grid-cols-2">
            ...
            <div className="">
              <Disclosure>
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left text-black focus:text-white focus:bg-black bg-gray-50 hover:bg-black hover:text-white rounded-lg focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                      <span>
                    ...
                    <Disclosure.Panel className="px-4 pt-3 pb-8 text-sm leading-7 text-gray-900">
                      {showingTranslateValue(
              ...
              <Disclosure as="div" className="mt-2">
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left focus:bg-black text-black focus:text-white bg-gray-50 hover:bg-black hover:text-white rounded-lg focus:outline-none">
                      <span>
                        {" "}
                        {showingTranslateValue(
              ...
              <Disclosure>
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left focus:bg-black text-black focus:text-white bg-gray-50 hover:bg-black hover:text-white rounded-lg focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                      <span>
                        {" "}
                        {showingTranslateValue(
