...
const SignUp = () => {
  const { handleSubmit, submitHandler, isOpen, register, errors, loading } =
    useSignUpSubmit();
                  ...
                  <div className="grid grid-cols-1 gap-5">
                    ...
                    {loading ? (
                      ...
                      <button
                        disabled={loading}
                        type="submit"
                        className="w-full text-center py-3 rounded bg-gray-800 text-white hover:bg-black transition-all focus:outline-none my-1"
                      >
                        Register
                      </button>
                    )}
