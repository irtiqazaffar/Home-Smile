              ...
              <div className="mt-5 md:mt-0 md:col-span-2">
                <form onSubmit={handleSubmit(submitHandler)}>
                  ...
                  <div className="form-group mt-12">
                    ...
                    />
                    <div className="grid grid-cols-6 gap-6">
                      { showingTranslateValue(storeCustomizationSetting?.checkout?.shipping_one_desc) && (
                        <div className="col-span-6 sm:col-span-3">
                        <InputShipping
                          currency={currency}
                      ...
                      { showingTranslateValue(storeCustomizationSetting?.checkout?.shipping_two_desc) && (
                        <div className="col-span-6 sm:col-span-3">
                        <InputShipping
                          currency={currency}
                          handleShippingCost={handleShippingCost}
                    ...
                    <div className="grid gap-4">
                      ...
                      <div className="">
                        <InputPayment
                          setShowCard={setShowCard}
                          register={register}
                          name="RazorPay (UPI, Cards, Wallets, NetBanking)"
                          description="Extra 10% Discount on Prepaid Order"
                          value="RazorPay"
                          Icon={ImCreditCard}
                        />
                        <Error errorMessage={errors.paymentMethod} />
                  ...
                  <div className="grid grid-cols-6 gap-4 lg:gap-6 mt-10">
                    { showingTranslateValue(storeCustomizationSetting?.checkout?.continue_button) && (
                      ...
                      <Link
                        href="/"
                        className="bg-gradient-to-r from-gray-700 via-gray-500 to-gray-900 hover:bg-gradient-to-r hover:from-gray-800 hover:via-gray-600 hover:to-gray-900 border border-gray-900 py-3 text-center text-sm rounded-md font-medium text-white transition-all flex justify-center w-full"
                      >
                    ...
                    { showingTranslateValue(storeCustomizationSetting?.checkout?.confirm_button) && (
                      ...
                      <button
                        ...
                        className="bg-gradient-to-r from-gray-600 via-green-500 to-green-800 hover:bg-gradient-to-r hover:from-gray-700 hover:via-green-600 hover:to-green-900 border border-gray-700 transition-all py-3 text-center text-sm rounded-md font-medium text-white flex justify-center w-full"
                      >
                        {isCheckoutSubmit ? (
                      ...
                      <div className="flex flex-col sm:flex-row items-start justify-end">
                        ...
                        {isCouponAvailable ? (
                          ...
                          <button
                            ...
                            className="md:text-sm rounded-md leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold text-center justify-center border bg-gradient-to-r from-gray-600 via-green-500 to-green-800 hover:bg-gradient-to-r hover:from-gray-700 hover:via-green-600 hover:to-green-900 border-gray-200 placeholder-white focus-visible:outline-none focus:outline-none px-5 md:px-6 lg:px-8 py-3 md:py-3.5 lg:py-3 mt-3 sm:mt-0 sm:ml-3 md:mt-0 md:ml-3 lg:mt-0 lg:ml-3 hover:text-white h-12 text-sm lg:text-base w-full sm:w-auto"
                          >
                            {showingTranslateValue(
