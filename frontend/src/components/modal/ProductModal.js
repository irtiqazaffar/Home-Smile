              ...
              <div className="flex items-center mt-4">
                <div className="flex items-center justify-between space-s-3 sm:space-s-4 w-full">
                  ...
                  <button
                    ...
                    className="text-sm leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold font-serif text-center justify-between border-0 border-transparent rounded-md focus-visible:outline-none focus:outline-none text-white px-4 ml-4 md:px-6 lg:px-8 py-4 md:py-3.5 lg:py-4 hover:text-white bg-emerald-500 hover:bg-emerald-600 w-full h-12"
                  >
                    {t("common:addToCart")}
                    <span className="ml-1 rounded-lg font-bold py-2 px-3 bg-white text-emerald-600">
                  ...
                  <div>
                    ...
                    <div>
                      <span className="font-serif font-semibold py-1 text-sm d-block">
                        ...
                        <span className="text-emerald-600 font-serif font-medium">
