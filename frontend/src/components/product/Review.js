...
const Review = ({customer, product, ratings}) => {
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start mb-6 space-y-6 lg:space-y-0 lg:space-x-6">
          ...
          <div className="space-y-2">
            ...
            return (
                ...
                <span className="flex-1 bg-gray-200 h-2 rounded-full">
                    ...
                    style={{ width: `${(count / 10) * 100}%` }} // Adjust width based on some scale
                    ></span>
                </span>
        ...
        <div className="lg:w-1/2 w-full">
          ...
          <form className="mt-4" onSubmit={handleSubmit(submitHandler)}>
            ...
            {/* Review textarea */}
            <div className="mb-4">
              <label htmlFor="review" className="block text-black">
                Your Review
              </label>
              <textarea
                {...register("comment", {
            ...
            {loading ? (
              <button
                disabled={loading}
                type="submit"
                className="inline-flex items-center justify-center cursor-pointer w-full text-center py-3 rounded bg-gray-700 text-white hover:bg-black transition-all focus:outline-none my-1"
              >
                <img
              ...
              <button
                disabled={loading}
                type="submit"
                className="w-full text-center py-3 rounded bg-black text-white hover:bg-black transition-all focus:outline-none my-1"
              >
                Add Review
              </button>
            )}
