  ...
  return (
    <>
      <a
        ...
        className="flex items-center rounded-md hover:bg-gray-50 w-full hover:text-emerald-600 border border-gray-200 px-4 py-2 rounded-xl mt-2"
        role="button"
      >
        {icon ? (
        ...
        <div className="inline-flex items-center justify-between ml-3 text-sm font-medium w-full hover:text-emerald-600">
          {title}
          {nested?.length > 0 && (
            <span className="transition duration-700 ease-in-out inline-flex loading-none items-end text-gray-900">
            ...
            <li key={children._id}>
              {children.children.length > 0 ? (
                <a
                  ...
                  className="flex items-center font-serif pr-2 text-sm text-gray-900 hover:text-emerald-600 py-1 cursor-pointer"
                >
                ...
                <a
                  ...
                  className="flex items-center font-serif py-1 text-sm text-gray-900 hover:text-emerald-600 cursor-pointer"
                >
                  <span className="text-xs text-gray-900 pr-2">
                    <IoRemoveSharp />
                  </span>
                  {showingTranslateValue(children.name)}
                </a>
