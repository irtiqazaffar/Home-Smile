...
const useStoreHomeSubmit = () => {
  ...
  const [exchangeRefundPolicy, setExchangeRefundPolicy] = useState(true);
  ...
  const [exchangeReturnPolicyTextEdit, setExchangeReturnPolicyTextEdit] = useState(
    createEditorState("")
  );
  ...
  const [exchangeRefundPolicyBg, setExchangeRefundPolicyBg] = useState("");
      ...
      const storeCustomizationSettingData = {
        ...
        setting: {
          ...
          exchange_and_return_policy: {
            status: exchangeRefundPolicy,
            header_bg: exchangeRefundPolicyBg,
            title: handleRemoveEmptyKey({
              ...resData?.exchange_and_return_policy?.title,
              [language]: data.exchange_and_return_policy_page_title || "",
            }),

            description: {
              ...resData?.exchange_and_return_policy?.description,
              [language]: exchangeReturnPolicyTextEdit
                ? draftToHtml(
                    convertToRaw(exchangeReturnPolicyTextEdit.getCurrentContent())
                  )
                : "",
            },
          },
          ...
          footer: {
            ...
            bottom_contact_title: data.footer_Bottom_Contact_Title,
          },
          slug: {
    ...
    const getStoreCustomizationData = async () => {
      try {
        ...
        if (res) {
          ...
          setValue("footer_Bottom_Contact_Title", res?.footer?.bottom_contact_title);
          ...
          setExchangeRefundPolicy(res?.exchange_and_return_policy?.status);
          setExchangeRefundPolicyBg(res?.exchange_and_return_policy?.header_bg);
          setValue(
            "exchange_and_return_policy_page_title",
            res?.exchange_and_return_policy?.title[language || "en"]
          );

          setExchangeReturnPolicyTextEdit(
            createEditorState(
              showingTranslateValue(res?.exchange_and_return_policy?.description || "")
            )
          );
  ...
  return {
    ...
    setTermsConditionsTextEdit,
    isSubmitting, 
    setExchangeRefundPolicy,
    exchangeRefundPolicy,
    setExchangeRefundPolicyBg,
    exchangeRefundPolicyBg,
