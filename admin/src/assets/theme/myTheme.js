const myTheme = {
  ...
  alert: {
    ...
    danger: "bg-teal-50 text-teal-900 dark:bg-teal-600 dark:text-white",
    ...
    icon: {
      ...
      danger: "text-teal-400 dark:text-teal-300",
  ...
  badge: {
    ...
    danger: "text-teal-500 bg-teal-100 dark:text-teal-100 dark:bg-teal-800",
  ...
  textarea: {
    ...
    invalid:
      "border-teal-600 dark:bg-gray-700 focus:border-teal-400 dark:focus:border-teal-400",
  },
  // Select
  select: {
  ...
  helperText: {
    ...
    invalid: "text-teal-600 dark:text-teal-400",
  },
  // Card
  card: {
  ...
  button: {
    ...
    delete: {
      base: "text-teal-600 border-teal-200 border dark:text-teal-400 focus:outline-none",
      active:
        "rounded-lg border border-teal-200 px-4 w-full mr-3 flex items-center justify-center cursor-pointer h-12 bg-teal-400",
      disabled: "opacity-50 cursor-not-allowed bg-teal-300",
    },
