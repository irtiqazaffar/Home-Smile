  ...
  return (
    <>
      ...
      >
              ...
              <Table>
                <TableHeader>
                  <tr>
                    ...
                    <TableCell className="text-center">{"Refrence No"}</TableCell>
                    <TableCell className="text-center">Product Title</TableCell>
                    <TableCell className="text-center">MFR</TableCell>
        ...
        {!loading && (
          <div className="border rounded-xl border-gray-100 p-8 py-6 bg-gray-50 dark:bg-[#171717] dark:border-gray-800">
            <div className="flex lg:flex-row md:flex-row flex-col justify-between">
              ...
              <div className="flex flex-col sm:flex-wrap">
                ...
                <span className="text-xl font-serif font-bold text-teal-500 dark:text-emerald-500 block">
                  {currency}
                  {getNumberTwo(data.total)}
                </span>
              </div>
            </div>
            <div className="w-full text-right text-gray-500 dark:text-gray-400 font-semibold font-serif mt-2">
