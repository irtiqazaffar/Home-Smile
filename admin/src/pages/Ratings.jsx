...
const Ratings = () => {
    ...
    const { data, loading, error } = useAsync(RatingServices.getAllRatings);

    const { handleDeleteMany, allId, serviceId } = useToggleDrawer();

    const { t } = useTranslation();

    const { can } = usePermission("rating");
                    ...
                    <Table>
                        <TableHeader>
                            <tr>
                                ...
                                <TableCell>{t("RatingTbCustomerName")}</TableCell>
                                <TableCell>{t("RatingTbProductName")}</TableCell>
