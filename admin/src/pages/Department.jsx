...
const Department = () => {
    ...
    return (
        <>
            ...
            <AnimatedContent>
                {(can.delete || can.add) && (
                    <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-black mb-5">
                        <CardBody className="">
                ...
                <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-black rounded-t-lg rounded-0 mb-4">
                    <CardBody>
                        <form
