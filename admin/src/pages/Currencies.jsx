...
const Currencies = () => {
  ...
  const { can } = usePermission("currency");
          ...
          <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-gray-800 mb-5">
            <CardBody>
              <form
                ...
                className="py-3 grid gap-4 lg:gap-6 xl:gap-6 md:flex xl:flex md:justify-end"
              >
                ...
                <div className="lg:flex  md:flex xl:justify-end xl:w-1/2  md:w-full md:justify-start flex-grow-0">
                  ...
                  {can.delete && (
                    <div className="w-full md:w-32 lg:w-32 xl:w-32 mr-3 mb-3 lg:mb-0">
                      <Button
                        ...
                        className="w-full rounded-md h-12 bg-teal-500 btn-teal"
                      >
                        <span className="mr-2">
                          <FiTrash2 />
                        </span>
                  ...
                  {can.add && (
                    <Button onClick={toggleDrawer} className="rounded-md h-12 w-full md:w-64 lg:w-64 xl:w-64">
                      <span className="mr-2">
                        <FiPlus />
                      </span>
                      Add Currency
