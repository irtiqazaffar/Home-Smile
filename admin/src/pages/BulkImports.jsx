...
const BulkImports = () => {
    ...
    const handleDownloadSample = () => {
        ...
        // }
            ...
            sampleCSVContent = "data:text/csv;charset=utf-8,title,isCodAvaialble,description,sku,barcode,brand,categories,stock,tag,originalPrice,salePrice,mpq,packing,metatitle,metadescription";
        }
