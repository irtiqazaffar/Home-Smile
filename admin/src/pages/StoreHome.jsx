            ...
            <div className="sm:container md:p-6 p-4 mx-auto bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg">
              <form onSubmit={handleSubmit(onSubmit)}>
                <HomePage
                  ...
                  setProductsMenuLink={setProductsMenuLink}
                  productsMenuLink={productsMenuLink}
                  setNewProductMenuLink={setNewProductMenuLink}
                  newProductMenuLink={newProductMenuLink}
            ...
            <div className="sm:container md:p-6 p-4 mx-auto bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg">
              <form onSubmit={handleSubmit(onSubmit)}>
                <PrivacyPolicy
                  ...
                  isSubmitting={isSubmitting}
                  setExchangeReturnPolicy={setExchangeRefundPolicy}
                  exchangeReturnPolicy={exchangeRefundPolicy}
                  setExchangeReturnPolicyHeaderBg={setExchangeRefundPolicyBg}
                  exchangeReturnPolicyHeaderBg={exchangeRefundPolicyBg}
                  exchangeReturnPolicyTextEdit={exchangeReturnPolicyTextEdit}
                  setExchangeReturnPolicyTextEdit={setExchangeReturnPolicyTextEdit}
                />
              </form>
            </div>
          </AnimatedContent>
