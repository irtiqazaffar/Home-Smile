...
const ChildCategory = () => {
  ...
  const { can } = usePermission("category");
  ...
  return (
    <>
      ...
      <AnimatedContent>
        <div className="flex items-center pb-4">
          <ol className="flex items-center w-full overflow-hidden font-serif">
            <li className="text-sm pr-1 transition duration-200 ease-in cursor-pointer  text-gray-400 hover:text-emerald-500 font-semibold">
            ...
            {selectedObj?.map((child, i) => (
              <span key={i + 1} className="flex items-center font-serif">
                ...
                <li className="text-sm pl-1 transition duration-200 ease-in cursor-pointer text-gray-400 hover:text-emerald-500 font-semibold ">
          ...
          <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-gray-800 mb-5">
            <CardBody>
              <div className="w-full flex justify-end flex-grow-0">
                {can.delete && (
                  <div className="w-full md:w-48 lg:w-48 xl:w-48 mr-3">
                ...
                {can.add && (
                  <div className="w-full md:w-48 lg:w-48 xl:w-48">
                    ...
                    <Button
                      ...
                      className="w-full rounded-md h-12 bg-teal-500 disabled  btn-teal"
                    >
                      <span className="mr-3">
                        <FiTrash2 />
                      </span>
      ...
      {loading ? (
        ...
        <span className="text-center mx-auto text-teal-500">{error}</span>
