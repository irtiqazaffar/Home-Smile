  ...
  const handleChangeStatus = async (id) => {
    ...
    try {
      ...
      if (location.pathname === "/departments") {
        const res = await DepartmentService.updateStatus(id, {
          status: newStatus,
        });
        setIsUpdate(true);
        notifySuccess(res.message);
      ...
      if (location.pathname === "/roles-and-permission") {
        const res = await RoleAndPermissionServices.updateStatus(id, {
          status: newStatus,
        });
        setIsUpdate(true);
        notifySuccess(res.message);
      ...
      if (location.pathname === "/ratings") {
        const res = await RatingServices.updateStatus(id, {
          status: newStatus,
        });
        setIsUpdate(true);
        notifySuccess(res.message);
