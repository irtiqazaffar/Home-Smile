      ...
      <TableBody className="bg-white dark:bg-gray-800 divide-y divide-gray-100 text-serif text-sm ">
        {data?.cart?.map((item, i) => (
          <TableRow key={i} className="dark:border-gray-700 dark:text-gray-400">
            ...
            <TableCell className="px-6 py-1 whitespace-nowrap font-normal text-gray-500 text-center">
              {item?.hsn || "N/A"}
            </TableCell>
            <TableCell className="px-6 py-1 whitespace-nowrap font-normal text-gray-500 text-center">
            ...
            <TableCell className="px-6 py-1 whitespace-nowrap font-normal text-gray-500 text-center">
              <span
                className={`text-gray-700 font-semibold  dark:text-gray-300 text-xs ${item.title.length > 15 ? "wrap-long-title" : "" // Apply class conditionally
                  }`}
              >
                {item.title}
              </span>
