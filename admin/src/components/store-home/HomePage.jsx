      ...
      <div className="grid grid-cols-12 font-sans pr-4">
            ...
            <div className="sm:col-span-4 md:pl-3 sm:pl-2">
              ...
              <div className="grid grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="col-span-4">
                  ...
                  <InputAreaTwo
                    register={register}
                    label={"New Product Addition"}
                    name="newProduct"
                    type="text"
                    placeholder={"New Product Addition"}
                  />
                  <Error errorName={errors.newProduct} />
                </div> */}
                <div className="col-span-4">
                  <label className="block md:text-sm md:col-span-1 sm:col-span-2 text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1">
                    {t("AboutUs")}
              ...
              <div className="grid xl:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                {/* <div>
                  ...
                  <SwitchToggle
                    title={""}
                    handleProcess={setProductsMenuLink}
                    processOption={productsMenuLink}
                  />
                </div>
                <div>
                  <h4 className="font-medium font-serif md:text-base text-sm mb-2 dark:text-gray-300">
                  ...
                  <SwitchToggle
                    title={""}
                    handleProcess={setNewProductMenuLink}
                    processOption={newProductMenuLink}
                  />
                </div> */}
                <div>
                  <h4 className="font-medium font-serif md:text-base text-sm mb-2 dark:text-gray-300">
        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12">
          <div className="inline-flex md:text-lg text-base text-gray-800 font-semibold dark:text-gray-400 mb-3 md:mt-0 mt-10">
            <FiSettings className="mt-1 mr-2" /> {"Header Content"}
          </div>
              ...
              {/* <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo
                    ...
                    type="text"
                    placeholder="New Product Additions"
                  />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo
                    register={register}
                    label="Title"
                    name="footer_block_one_link_five_title"
                    type="text"
                    placeholder={""}
                  />
                  <Error errorName={errors.footer_block_one_link_five_title} />
                </div>
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4 mb-5">
                  <InputAreaTwo
                    register={register}
                    label="Title"
                    name="footer_block_one_link_five"
                    type="text"
                    placeholder={t("Link")}
                  />
                  <Error errorName={errors.footer_block_one_link_five} />
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="sm:col-span-4 mb-20 md:mb-0">
                <InputAreaTwo
                  register={register}
                  label="Title"
                  name="footer_Bottom_Contact_Title"
                  type="text"
                  placeholder={"Footer Bottom Contact Title"}
                />
                <Error errorName={errors.footer_Bottom_Contact_Title} />
              </div>
            </div>
            <div
              style={{
