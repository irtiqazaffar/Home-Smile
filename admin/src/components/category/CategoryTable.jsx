...
const CategoryTable = ({
  ...
  const { can, editButtonCLick, deleteButtonCLick } = usePermission("category", handleUpdate, handleModalOpen);
        ...
        {categories?.map((category) => (
          <TableRow key={category._id}>
            ...
            <TableCell className="text-center">
              <ToggleStatusButton id={category._id} status={category.status} canToggleStatus={can.edit}/>
            </TableCell>
            <TableCell>
              <EditDeleteButton
                id={category?._id}
