  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; line-height: 1.5;">
        ...
        <p>If you have any questions or need assistance, please don't hesitate to contact our support team at <a href="sales@Home Smile.com">sales@Home Smile.com</a>.</p>
        <p>Thank you for choosing us! We truly appreciate your business and look forward to serving you again.</p>
        <p style="margin-top: 20px;">Best Regards,<br>Decor N Company Team</p>
      </div>
    `
  };
...
const addOrder = async (req, res) => {
  ...
  try {
    ...
    // const maxCouponDiscountPercent = Number(globalSetting.setting.max_coupon_discount_percent) || 5;
    // const maxCouponDiscountAmount = Number(globalSetting.setting.max_coupon_discount_amount) || 500;
    const percentCoupon = await Coupon.findOne({ minimumAmount: { $gte: minCouponAmount }, 'discountType.type': 'percentage' });
    // const percentAmount = (newOrder?.total * maxCouponDiscountPercent) / 100;
    ...
    if (req.body.couponId != null) {
      await Customer.updateOne(
        ...
        {
          $pull: {
            coupons: { coupon: req.body.couponId }
          },
        }
      );
    } else {
