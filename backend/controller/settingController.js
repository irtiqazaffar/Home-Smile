    ...
    const globalSetting = await Setting.updateOne(
      ...
      },
      {
        $set: {
          ...
          "setting.min_coupon_amount": req.body.setting.min_coupon_amount,
          "setting.max_refund_days": req.body.setting.max_refund_days,
          "setting.max_coupon_discount_percent": req.body.setting.max_coupon_discount_percent,
          "setting.max_coupon_discount_amount": req.body.setting.max_coupon_discount_amount,
    ...
    const storeCustomizationSetting = await Setting.findOneAndUpdate(
      ...
      },
      {
        $set: {
          ...
          "setting.navbar.newProduct": setting.navbar.newProduct,
          "setting.navbar.products": setting.navbar.products,
          "setting.navbar.categories": setting.navbar.categories,
          ...
          "setting.exchange_and_return_policy.status":
            setting.exchange_and_return_policy.status,
          "setting.exchange_and_return_policy.header_bg":
            setting.exchange_and_return_policy.header_bg,
          "setting.exchange_and_return_policy.title": setting.exchange_and_return_policy.title,
          "setting.exchange_and_return_policy.description":
            setting.exchange_and_return_policy.description,
          ...
          "setting.footer.block1_sub_title5": setting.footer.block1_sub_title5,
          "setting.footer.block1_sub_link5": setting.footer.block1_sub_link5,
          ...
          "setting.footer.bottom_contact_title": setting.footer.bottom_contact_title,
