...
Home Smile Server Documentation - Updated backend


Introduction: 

This is ready api backend for Home Smile admin and frontend built with node.js, express, mongoose, and mongodb for database. 
