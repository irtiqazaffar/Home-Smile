...
>
 ...
 <h2>Hello ${option.name}</h2>
    <p>A request has been received to add you as ${option.role === "Admin" ? "an" : "a"
    } <strong>${option.role
    }</strong> in <span style="text-transform: capitalize;"><strong>${option.cname
      ...
      <a href=https://${option.cname}.app-dev.dashter.com/reset-password/${option.token
    }  style="background:#3b82f6;color:white;border:1px solid #3b82f6; padding: 10px 15px; margin-right: 20px; border-radius: 4px; text-decoration:none;">Reset Password </a>  <a href="https://${option.cname
     ...
     <p style="margin:0px auto; margin-top:40px; text-align:center;">Thank you   <h4 style="margin:1px; margin-bottom:0px; text-align:center;">Home Smile Team</p></p>
